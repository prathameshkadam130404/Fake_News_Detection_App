...
try:
    ...
    st.warning(f"Could not load .env file: {str(e)}")
    st.info("Please create a .env file with your NEWS_API_KEY")
...
def load_model():
    model = xgb.Booster()
    model.load_model('model/fake_news_model.json')
